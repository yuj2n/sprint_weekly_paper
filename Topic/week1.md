...
![image](https://github.com/user-attachments/assets/965bedb7-73f7-4c4b-a6d1-3a2c97eb6a2c)
...
- ![image](https://github.com/user-attachments/assets/fab77d2a-f4cd-4313-adbe-053e163e0cb1)

- 이 중 시각장애인은 인터넷 사용에 어려움을 겪음
-> screen reader라는 화면을 소리내어 읽어주는 프로그램 사용
  ![image](https://github.com/user-attachments/assets/6fe24765-5862-4ecc-bf70-efe0d91bc3b9)

- 이때, 시맨틱 태그를 사용 시 **장벽 없는 인터넷**을 만들 수 있음.
  

## 3. 개발자의 생산성 향상
![image](https://github.com/user-attachments/assets/d669f40a-031c-4732-88e5-9c47fb6ff14d)
